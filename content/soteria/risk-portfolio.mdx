...
**Function:** Calculates compounded value of \$1: $V_t=\prod_{\tau\le t}(1+r_{\tau,p})$ and draws a line chart.
...
**Function:** Solves a Markowitz‑style problem—e.g. minimize variance $w^T\Sigma w$ or maximize Sharpe.
